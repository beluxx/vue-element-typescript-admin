...
export default class RightPanel extends Vue {
  ...
  private show = false
  @State(state => state.settings.theme) readonly theme!: string
...
.rightPanel-background {
  @apply fixed top-0 left-0 opacity-0;
...
.rightPanel {
  @apply w-full h-screen fixed top-0 right-0;
  width: 100%;
  max-width: 260px;
...
.handle-button {
  @apply absolute text-center cursor-pointer pointer-events-auto;
  width: 48px;
  height: 48px;
  left: -48px;
  font-size: 24px;
